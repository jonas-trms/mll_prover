...
\begin{demonstrationappendix}
    ...
    \begin{description}
        ...
        \begin{description}
            ...
            Par ailleurs, d'après le pseudo-code, ${\highapprox}^{i+1} = {\highapprox}^{i}_{\setminus \mathcal{M} \cup \{ (m, \someadd) \}} \cup \left\{ (m, \someadd \cdot \Left) \right\}$, où $\mathcal{M}$ est l'ensemble des adresses minimales de $t''$.
