...
\begin{remark}
     Cet ensemble est celui des adresses possibles pour le trou. On montrera, en justifiant la correction de l'assistant, que les utiliser pour substituer le trou conserve la correction partielle de la représentation.
\end{remark}
