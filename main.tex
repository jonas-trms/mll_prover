...
\todo{expliquer que l'ordre lexicographique sur les feuilles vient du fait qu'on veut représenter des paires d'adresses distinctes pas des couples, on implémente les paires comme des couples ordonnés}
